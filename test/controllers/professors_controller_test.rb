...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { address: @professor.address, name: @professor.name, phone: @professor.phone } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { address: @professor.address, name: @professor.name, phone: @professor.phone } }
